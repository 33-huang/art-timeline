        ...
        <div style={s.mvDropdown}>
          {filtered.length > 0 ? filtered.map(m => (
            <div key={m.id}
              ...
              style={{
                ...s.mvOption,
                ...(selected.includes(m.id) ? { color: 'var(--text)', fontWeight: 500 } : {}),
              }}>
...
const s = {
  ...
  tagList:     { display: 'flex', flexWrap: 'wrap', gap: 6, marginBottom: 6 },
  tag:         { fontSize: 11.5, color: 'var(--text-muted)' },
