...
export const s = {
  ...
  workCard:    { display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 3, maxWidth: 110 },
  workThumb:   { height: 84, borderRadius: 6, border: '1px solid var(--axis-border)', cursor: 'zoom-in', display: 'block' },
  workCaption: { fontSize: 10, color: 'var(--text-muted)', textAlign: 'center', lineHeight: 1.3 },
  workCaptionA:{ fontSize: 10, color: 'inherit', textAlign: 'center', lineHeight: 1.3, textDecoration: 'underline', cursor: 'pointer' },
  zoomOverlay: {
